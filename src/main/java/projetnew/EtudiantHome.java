...
public class EtudiantHome {
	...
	public Etudiant findById(int id) {
		...
		try {
			Etudiant instance = (Etudiant) sessionFactory.getCurrentSession().get("projetnew.Etudiant", id);
			if (instance == null) {
	...
	public List findByExample(Etudiant instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("projetnew.Etudiant")
