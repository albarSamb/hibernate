...
public class ClasseHome {
	...
	public Classe findById(int id) {
		...
		try {
			Classe instance = (Classe) sessionFactory.getCurrentSession().get("projetnew.Classe", id);
			if (instance == null) {
	...
	public List findByExample(Classe instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("projetnew.Classe")
