...
public class EnseignantHome {
	...
	public Enseignant findById(int id) {
		...
		try {
			Enseignant instance = (Enseignant) sessionFactory.getCurrentSession().get("projetnew.Enseignant", id);
			if (instance == null) {
	...
	public List findByExample(Enseignant instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("projetnew.Enseignant")
