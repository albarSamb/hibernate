...
public class PersonneHome {
	...
	public Personne findById(int id) {
		...
		try {
			Personne instance = (Personne) sessionFactory.getCurrentSession().get("projetnew.Personne", id);
			if (instance == null) {
	...
	public List findByExample(Personne instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("projetnew.Personne")
